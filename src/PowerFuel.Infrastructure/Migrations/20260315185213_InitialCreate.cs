        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageRating = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: true),
                    ReviewCount = table.Column<int>(type: "int", nullable: false),
                    FeaturedCoachId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Equipments_Coaches_FeaturedCoachId",
                        column: x => x.FeaturedCoachId,
                        principalTable: "Coaches",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionBookings_Coaches_CoachId",
                        column: x => x.CoachId,
                        principalTable: "Coaches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EquipmentReviews_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipmentReviews_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CartItem_Item", "ProductId IS NOT NULL OR EquipmentId IS NOT NULL");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_OrderItem_Item", "ProductId IS NOT NULL OR EquipmentId IS NOT NULL");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentReviews_EquipmentId",
                table: "EquipmentReviews",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_EquipmentReviews_UserId",
                table: "EquipmentReviews",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipments_FeaturedCoachId",
                table: "Equipments",
                column: "FeaturedCoachId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionBookings_CoachId",
